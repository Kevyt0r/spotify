         ...
         <div class="contact-warp">
            <div class="section-title mb-0">
               ...
               <?php if (
                   ...
                   echo '<div class="form-row row" style="width: 40%; margin: 0 auto;">
                   ...
                   echo '</select></div>
                                 <h5 align="center" class="d-flex justify-content-center" style="margin: 0 auto; font-size: 70%;">If your country is out of stock, you can select another and still upgrade. You\'ll experience minor differences
                                    in the music catalog, but all premium features will be accessible until we restock your country.</h5>
                                 </div>
