...
if (isset($_POST["key"])) {
    ...
    if (isset($info->invite)) {
        $invite = $info->invite;
    }
    if (isset($info->address)) {
        $address = $info->address;
    }
    if (isset($info->verify_address)) {
        $verify_address = $info->verify_address;
    }
    ...
    if (isset($status)) {
        ...
        if (isset($info->used_date)) {
            $used_date = $info->used_date;
        }
        switch ($status) {
            ...
            case "success_renew":
                $message = "Key Renewed, you can now use it again to upgrade";
                break;
   ...
   <body>
      ...
      <header class="header-section clearfix">
         <a href="index.html" class="site-logo">
            <h3 id="changeMe" style="color:white;">SPOTIFY <font style="color: #FC0254">SERVICE</font></h3>
            <script>
               ...
               <div class="col-lg-12 p-0">
                  <div class="contact-warp">
                     <div class="section-title mb-0">
                        ...
                        if (
                           ...
                           <ul style="text-size-adjust: 1; font-size: 20px; line-height: 1.5em; text-align: center;">';
                            if (isset($message) && $message != "none") {
                                echo '<li><span style="font-size: 130%;"><b>STATUS:</b> <span style="color: #E33060;">' .
                                    $message .
                                    "</span></span></li>";
                            }
                            echo '
                           <li><b>KEY:</b> ' .
                                ...
                                "</li>";
                            if (isset($address)) {
                                echo '</br><li><b>UPGRADE LINK:</b> <a href="https://www.spotify.com/uk/family/join/invite/' .
                                    $invite .
                                    '" target="_blank">Spotify Premium Invitation</a></li>';
                            }
                            if (isset($address)) {
                                echo "<li><b>ADDRESS:</b> " .
                                    $address .
                            ...
                            if (isset($verify_address)) {
                                echo "<li><b>ADDRESS:</b> " .
                                    $verify_address .
                                    "</li></br>";
                            }
                            if (isset($usable)) {
                                echo "<li><b>USABLE:</b> " . $usable . "</li>";
                            }
                            if (
                                isset($message) &&
                                $message == "none" &&
                                ...
                                echo "<li><b>PURCHASED:</b> " .
                                    $purchase_date .
                                    "</li>";
                            }
                            if (
                                isset($used_date) &&
                                $used_date != "1970-01-01 01:00"
                            ) {
                                echo "<li><b>LAST USE:</b> " .
                                    $used_date .
                                    "</li>";
                            }
                            echo '
                        ...
                        if (!isset($status) or $status != "not_exist") {
                            echo '
                           <form action="info.php" method="POST">
                           <div class="col-md-12 ">
                           <div align="center" class="d-flex justify-content-center">
                           <input type="text" style="width: 60%;" class="d-flex justify-content-center form-row" name="key" placeholder="XXXX-XXXX-XXXX-XXXX" required></div>
                           </div><div align="center" style="padding-top:3rem;" class="d-flex justify-content-center">
                           <button class="site-btn d-flex justify-content-center">check</button></div>
                           </div></form>';
                        } else {
                            echo '<ul style="text-size-adjust: 1; font-size: 20px; line-height: 1.5em; text-align: center; margin:0 auto;">
                           <li><b>' .
                                $message .
         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-6 col-lg-5 order-lg-1">
                  <div class="copyright">
                     Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | SPOTIFY SERVICE
                  </div>
               </div>
            </div>
         </div>
